document.addEventListener("DOMContentLoaded", ()=> {
    ...
    //Helper func: to split text into letters
    ...
    //fliker animation: intro text
    function flikerAnimation(targets, toOpacity) {
        gsap.to(targets, {
            opacity: toOpacity,
            duration: 0.05,
            stagger: {
    ...
    ScrollTrigger.create({
        ...
        onEnter: () => {flikerAnimation(".intro-col p span", 1)},
        onLeave: () => {flikerAnimation(".intro-col p span", 0)},
        onEnterBack: () => {flikerAnimation(".intro-col p span", 1)},
        onLeaveBack: () => {flikerAnimation(".intro-col p span", 0)},
    })
